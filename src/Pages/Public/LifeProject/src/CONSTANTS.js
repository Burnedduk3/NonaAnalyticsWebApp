const LifeProjectText = {
  firstPart: {
    ...
    list: [
      ...
      // eslint-disable-next-line max-len
      'What role does personalized medicine (ex. genetic testing) play in improving your quality of life?',
    ],
  },
  secondPart: {
  ...
  thirdPart: {
    ...
    item2: {
      title: '2015 | 2016',
      text: 'Residential recruitment began',
    },
    item3: {
      title: '2017',
      // eslint-disable-next-line max-len
    ...
    item4: {
      title: '2018',
      text: 'Creation of survey 2.0 Residential recruitment continued',
    },
    item5: {
      title: '2019',
      text: 'Launch survey 2.0',
    },
  },
};

export default LifeProjectText;
